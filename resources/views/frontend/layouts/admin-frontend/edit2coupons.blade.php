    ...
    <div class="card">
        <div class="card-block">
            ...
            @foreach ($coupons as $coupon)
                <form action="{{ route('updatecoupons') }}" method="post">
                    @csrf
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Food ID</label>
                        <div class="col-sm-10">
                            <input type="hidden" value="{{ $coupon->id }}" name="id">
                            <input value="{{ $coupon->id }}" type="text" class="form-control" id="id"
                                name="id" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Coupons Name</label>
                        <div class="col-sm-10">
                            <input value="{{ $coupon->coupon_name }}" type="text" class="form-control"
                                id="coupon_name" name="coupon_name" disabled>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Coupons Name Change</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="coupon_name_change" name="coupon_name_change">
                        </div>
                    </div>
                    <div class="form-group row">
